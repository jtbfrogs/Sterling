...
Requirements:
  ...
  - A Spotify developer app — create one at developer.spotify.com (free, 2 mins):
      ...
      2. Add redirect URI: http://127.0.0.1:8888/callback   (Spotify no longer allows 'localhost')
...
class Spotify:
    ...
    def __init__(
        ...
        client_id:     str,
        client_secret: str,
        redirect_uri:  str = "http://127.0.0.1:8888/callback",  # Spotify rejects 'localhost'
